...
DATABASES = {
    'default': {
        ...
        'NAME': 'barbingo',                      # Or path to database file if using sqlite3.
        # The following settings are not used with sqlite3:
        'USER': 'barbingoapp',
        'PASSWORD': 'scotchscotchscotch',
...
SECRET_KEY = 'h$&s$)8$ugqin%c!!d-0b(zik=jq7o0b-csjb*-s5)-1*3r($a'
...
ROOT_URLCONF = 'barbingo.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'barbingo.wsgi.application'
